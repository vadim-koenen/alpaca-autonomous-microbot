...
def _observation_from_dashboard(iteration: int, dashboard: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "runtime": {
            ...
            "bot_owned_open_positions": runtime.get("bot_owned_open_positions"),
            "external_inventory_count": runtime.get("external_inventory_count"),
            "external_inventory_symbols": runtime.get("external_inventory_symbols"),
            "max_open_slot_available": runtime.get("max_open_slot_available"),
