...
def sample_journal(path: Path) -> None:
    write_csv(path, [{'timestamp': '2026-05-30T10:00:00Z', 'symbol': 'BTC/USD', 'side': 'buy', 'quantity': '0.00001', 'price': '100000', 'notional': '1.00', 'fee_usd': '0.006', 'reason': 'controlled_exploration_entry'}, {'timestamp': '2026-05-30T11:30:00Z', 'symbol': 'BTC/USD', 'side': 'sell', 'quantity': '0.00001', 'price': '100500', 'notional': '1.005', 'fee_usd': '0.00603', 'reason': 'max_hold_exit'}])

def sample_price_path(path: Path) -> None:
    write_csv(path, [{'timestamp_utc': '2026-05-30T10:15:00Z', 'symbol': 'BTC/USD', 'position_id': 'BTC-1', 'entry_timestamp': '2026-05-30T10:00:00+00:00', 'entry_price': '100000', 'current_price': '100700', 'unrealized_pct': '0.70', 'hold_minutes': '15'}, {'timestamp_utc': '2026-05-30T10:45:00Z', 'symbol': 'BTC/USD', 'position_id': 'BTC-1', 'entry_timestamp': '2026-05-30T10:00:00+00:00', 'entry_price': '100000', 'current_price': '99700', 'unrealized_pct': '-0.30', 'hold_minutes': '45'}, {'timestamp_utc': '2026-05-30T11:00:00Z', 'symbol': 'BTC/USD', 'position_id': 'BTC-1', 'entry_timestamp': '2026-05-30T10:00:00+00:00', 'entry_price': '100000', 'current_price': '101300', 'unrealized_pct': '1.30', 'hold_minutes': '60'}])
...
def test_reconstructs_notional_from_quantity_price(tmp_path):
    ...
    journal = tmp_path / 'journal.csv'
    write_config(config)
    write_csv(journal, [{'timestamp': '2026-05-30T10:00:00Z', 'symbol': 'ETH/USD', 'side': 'buy', 'quantity': '0.01', 'price': '100', 'fee_usd': '0.01', 'reason': 'entry'}, {'timestamp': '2026-05-30T10:10:00Z', 'symbol': 'ETH/USD', 'side': 'sell', 'quantity': '0.01', 'price': '101', 'fee_usd': '0.01', 'reason': 'tp'}])
    output = report.build_report(config, journal, tmp_path / 'missing.csv')
...
def test_forbidden_live_imports_absent():
    ...
    forbidden_patterns = ['import broker', 'from broker', 'import order_manager', 'from order_manager', 'import risk_manager', 'from risk_manager', 'from main import', 'import main']
